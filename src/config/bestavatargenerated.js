...
export const CURRENT_PERFECT_PROMPT = {
  ...
  quality: 'OPTIMAL',
  notes: 'This is the current production prompt after fixing scary/distorted avatar issues. Uses natural language instead of camera jargon, gentler parameters (strength 0.65, guidance 5.5), and cleaned negative prompts without contradictions.',
  rating: 5
};
...
export const PROMPT_TIPS = [
  ...
  'Full-body requires 9:16 aspect ratio (1152x2048)',

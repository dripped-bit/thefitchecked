...
const AvatarHomepage: React.FC<AvatarHomepageProps> = ({
  ...
  // Create new avatar handler with 3-avatar limit
          ...
          <div className="lg:col-span-2 flex flex-col items-center">
            ...
            <div className="mt-4 flex justify-center space-x-3">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 hover:scale-105 shadow-lg"
              >
                <Camera className="w-4 h-4" />
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                You can save up to 3 avatars. Please delete an existing avatar to create a new one.
              </p>
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => {
                    setShowAvatarLimitModal(false);
                    setShowSavedAvatarsTab(true); // Open saved avatars to manage
                  }}
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg font-medium hover:shadow-lg transition-all"
                >
                  Manage Avatars
                </button>
              </div>

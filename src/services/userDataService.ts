...
class UserDataService {
  ...
  saveUserProfile(profile: UserProfile): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Profile saved');
    }
  }
  ...
  saveAvatarData(avatar: AvatarData): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Avatar saved');
    }
  }
  ...
  saveMeasurements(measurements: UserMeasurements): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Measurements saved');
    }
  }
  ...
  saveStyleProfile(styleProfile: StyleProfile): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Style profile saved');
    }
  }
  ...
  saveClosetItems(items: ClothingItem[]): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log(`💾 [USER-DATA] Closet saved (${items.length} items)`);
    }
  }
  ...
  addToCloset(item: ClothingItem): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Item added to closet');
    }
  }
  ...
  removeFromCloset(itemId: string): void {
    if (this.userData) {
      ...
      if (index > -1) {
        ...
        this.saveUserData();
        console.log('💾 [USER-DATA] Item removed from closet');
      }
    }
  }
  ...
  saveWishlistItems(items: WishlistItem[]): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log(`💾 [USER-DATA] Wishlist saved (${items.length} items)`);
    }
  }
  ...
  addToWishlist(item: WishlistItem): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log('💾 [USER-DATA] Item added to wishlist');
    }
  }
  ...
  rateOutfit(rating: OutfitRating): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log(`🧠 [LEARNING] Outfit rated: ${rating.rating}`);
    }
  }
  ...
  trackInteraction(type: UserInteraction['type'], data: any, context?: UserInteraction['context']): void {
    if (this.userData) {
      ...
      this.saveUserData();
      console.log(`📊 [LEARNING] Tracked ${type} interaction`);
    }
  }
  ...
  markSetupCompleted(): void {
    if (this.userData) {
      ...
      this.userData.metadata.lastLogin = new Date().toISOString();
      this.saveUserData();
      console.log('✅ [USER-DATA] Setup marked as completed');
    }
  }
  ...
  private saveUserData(): void {
    if (this.userData) {
      try {
        ...
        console.log('💾 [USER-DATA] All data saved to localStorage');
      } catch (error) {
  ...
  importUserData(jsonData: string): boolean {
    try {
      ...
      this.saveUserData();
      console.log('✅ [USER-DATA] Data imported successfully');
      return true;
    } catch (error) {
  ...
  clearAllData(): void {
    ...
    this.userData = this.createEmptyUserData();
    this.saveUserData();
    console.log('🗑️ [USER-DATA] All data cleared');
  }

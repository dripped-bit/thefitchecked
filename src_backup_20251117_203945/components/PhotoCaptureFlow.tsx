...
const PhotoCaptureFlow: React.FC<PhotoCaptureFlowProps> = ({ onNext }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col px-4 sm:px-6 py-4 sm:py-8 relative overflow-hidden bg-white">
      {/* Background image with 40% opacity - same as welcome page */}
      <div 
      ...
      {/* Main Content Area - Top aligned for better centering - Mobile optimized spacing */}
      <div className="flex flex-col flex-grow justify-start items-center z-10 pt-8 space-y-4 sm:space-y-6">

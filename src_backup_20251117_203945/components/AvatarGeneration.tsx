...
const AvatarGeneration: React.FC<AvatarGenerationProps> = ({ uploadedPhoto, measurements: preMeasurements, onNext, onBack }) => {
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 py-4 sm:py-8 relative overflow-y-auto bg-gray-50">
      ...
      {isLoading && (
        <div className="flex flex-col items-center justify-center z-10 px-4 py-20">

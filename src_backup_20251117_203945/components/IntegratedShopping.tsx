...
const IntegratedShopping: React.FC<IntegratedShoppingProps> = ({
  ...
  const handleSaveToWishlist = async (selectedProduct?: ProductSearchResult) => {
    console.log('❤️ [INTEGRATED-SHOPPING] Save to Wishlist selected');
    setShowActionMenu(false);
    ...
    try {
      ...
      // Use selected product or last viewed
      const productToSave = selectedProduct || lastViewedProduct;
